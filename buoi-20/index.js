...
let staffs = [
    {
        id: 1,
        name: 'Angelina Jolie',
        image: 'https://images.unsplash.com/photo-1604004555489-723a93d6ce74?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=387&q=80',
        description: 'Some quick example text to build on the card title and make up the bulk of the cards content.'
    },
    {
        id: 2,
        name: 'Emma Watson',
        image: 'https://images.unsplash.com/photo-1620991725187-0dbd1970bbe3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=465&q=80',
        description: 'Some quick example text to build on the card title and make up the bulk of the cards content.'
    },
    {
        id: 3,
...
function updateStaff(id, objectChange) {
    ...
    let indexUpdate = staffs.findIndex(
        function(item) {
            if(item.id === id) {
                return true;
            } else {
...
updateStaff(
    ...
    {
        name: 'messi',
        image: 'https://i1-vnexpress.vnecdn.net/2021/12/17/messi-arghentina-7858-1639709584.jpg?w=0&h=0&q=100&dpr=1&fit=crop&s=gofrxU407d8LyJ-xAGKx2A'
    }
);
...
function deleteStaff(id) {
    ...
    let indexDelete = staffs.findIndex(
        function(item) {
            if(item.id === id) {
                return true;
            } else {
